...
st.set_page_config(page_title="Crypto Signal Dashboard v4.5.5", layout="wide")
st.title("🚀 Crypto Signal Dashboard v4.5.5 – Multi-Indicator Scoring")
        ...
        with cols[i % 3]:
            with st.container(border=True):
                ...
                for k, v in sig["subscores"].items():
                    score = v if v is not None else "N/A"
